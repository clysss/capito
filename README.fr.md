...
-   **SHA-256工作量证明**: Mécanisme de vérification de la sécurité basé sur le cryptage
...
-   **Algorithme de seau de jeton**: 防止突发请求
...
| Options               | 类型                | valeur par défaut         | décrire                           |
| --------------------- | ----------------- | ------------------------- | --------------------------------- |
